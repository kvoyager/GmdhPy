...
class NeuronTestCase(unittest.TestCase):
    ...
    def test_neuron_transfer(self):
        ...
        neuron = PolynomNeuron(
            0, 0, 1, RefFunctionType.rfCubic, 0, model_class="regression", loss="mse"
        )
    ...
    def test_neuron_error(self):
        ...
        res = neuron.loss_function(np.array([1.5, 1.6, 1.3]), np.array([1.0, 1.0, 1.0]))
        ...
        res = neuron.loss_function(["A", "A", "B"], np.array([0.9, 0.95, 0.1]))
