...
if __name__ == "__main__":
    ...
    plt.title(
        "{} informative feature, {} cluster per class".format(
    ...
    train_x, test_x, train_y, test_y = train_test_split(
        data_x, label_y, test_size=0.33, random_state=42
    )
    ...
    PlotModel(
        model, filename="simple_binary_classification_model", plot_neuron_name=True, view=True
    ).plot()
